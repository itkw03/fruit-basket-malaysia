        ...
        return (
          <div className="space-y-6">
            <div className="text-center">
              <h3 className="text-2xl font-display text-neutral-charcoal mb-2">Choose Your Color</h3>
              <p className="text-neutral-ash">Select your main color mood for your arrangement</p>
            </div>
                ...
                <motion.div
                  ...
                  className={`p-4 rounded-xl border-2 cursor-pointer transition-all ${
                    formData.colors.includes(mood.name)
                      ...
                      : 'border-neutral-ash/20 hover:border-primary-orange/50'
                  }`}
            ...
            <div className="text-center text-sm text-neutral-ash">
              Selected: {formData.colors.length > 0 ? formData.colors[0] : 'None'}
            </div>
          </div>
        );
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {fruits.map((fruit) => (
                <div
                  key={fruit.id}
                  className="p-4 rounded-xl border border-neutral-ash/20 hover:border-primary-orange/50 transition-all"
                >
                  <img
                    src={fruit.image}
                    alt={fruit.name}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        className="w-8 h-8 rounded-full bg-neutral-soft-blush flex items-center justify-center hover:bg-primary-orange hover:text-white transition-colors"
                      >
                        -
                      </button>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 border border-neutral-ash/20 rounded-full focus:border-primary-orange focus:outline-none"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-3 border border-neutral-ash/20 rounded-xl focus:border-primary-orange focus:outline-none"
                rows={3}
            ...
            <div className="bg-neutral-soft-blush/50 p-4 rounded-xl">
              ...
              <div className="space-y-1 text-sm">
                ...
                <p className="text-lg font-medium text-primary-orange pt-2">
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-neutral-ash/20">
            <div>
              <h2 className="text-xl font-display text-neutral-charcoal">Create Custom Arrangement</h2>
              ...
              {Array.from({ length: totalSteps }, (_, i) => (
                <div
                  ...
                  className={`flex-1 h-2 rounded-full transition-colors ${
                    i + 1 <= currentStep ? 'bg-primary-orange' : 'bg-neutral-ash/20'
                  }`}
                />
              ))}
            </div>
          ...
          {/* Disclaimer */}
          {currentStep === 1 && (
            <div className="mx-6 mt-4 p-4 bg-primary-orange/10 border border-primary-orange/20 rounded-xl">
