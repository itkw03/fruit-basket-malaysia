    ...
    <AnimatePresence>
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-neutral-ash/20">
              <div className="flex items-center">
                <i className="fa fa-shopping-basket w-6 h-6 text-primary-peach-coral mr-2" aria-hidden="true"></i>
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {cartItems.length === 0 ? (
                <div className="text-center py-12">
                  <i className="fa fa-shopping-basket w-12 h-12 text-neutral-ash mx-auto mb-4" aria-hidden="true"></i>
                  <p className="text-neutral-ash mb-4">Your basket is empty</p>
              ...
              <div className="border-t border-neutral-ash/20 p-6">
                ...
                <div className="space-y-2 mb-6">
                  ...
                  <div className="border-t border-neutral-ash/20 pt-2 flex justify-between">
                    ...
                    <span className="font-semibold text-primary-peach-coral">
                      RM{total.toFixed(2)}
                    </span>
                  </div>
                </div>
      ...
      <CheckoutModal
        ...
        onOrderComplete={(order) => {
          ...
          const existingOrders = JSON.parse(localStorage.getItem('fruitbasket_orders') || '[]');
          existingOrders.push(order);
          localStorage.setItem('fruitbasket_orders', JSON.stringify(existingOrders));
          
          // Redirect to payment confirmation page
          window.location.href = `/payment-confirmation/${order.id}`;
        }}
      />
    </AnimatePresence>
  );
